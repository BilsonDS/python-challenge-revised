...
#read csv then convert to dict
with open(election_csv_path, newLine="") as election_data:
    reader = csv.DictReader(election_data)
...
analysis_data = os.path.join("output", "analysis_data.txt")
with open(analysis_data, "w") as txt_file:
...
#save winner to text file
txt_file_write(winning_candidate_summary)
>>>>>>> acebbf9810e0b717683f70d1f7e092d6180fdafe
